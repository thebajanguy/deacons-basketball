...
export const INTEREST_OPTIONS = ['Practice Schedule', 'Rookie Academy — Boys & Girls 11 & Under', 'Junior Academy — Boys & Girls Ages 12–15', 'Junior Academy — Boys & Girls Ages 12–15', 'Girls Academy — All Ages & Skill Levels', 'Attend a Practice', 'Coaching', 'Sponsorship', 'Volunteer', 'Media', 'Other'] as const;
