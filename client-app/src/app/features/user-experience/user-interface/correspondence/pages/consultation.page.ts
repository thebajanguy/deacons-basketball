...
export class ConsultationPage  extends BasePageComponent {
  ...
  description = `
  Speak with a Deacons Basketball Club advisor about academics, athletic training, and scholarship pathways.
        We’ll map out a clear plan guided by our motto <em>Labor Durus</em> — “Hard Work Always Pays Off.”`.trim();
